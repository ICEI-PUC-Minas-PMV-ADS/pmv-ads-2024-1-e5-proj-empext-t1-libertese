...
namespace Libertese.Web.Controllers.Cadastro
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PermissaoID,Nome,Email,Senha,Id,DataCriacao,DataAtualizacao")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PermissaoID,Nome,Email,Senha,Id,DataCriacao,DataAtualizacao")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
